...
class JSONStorageBackend(StorageBackend):
    ...
    def __init__(self, file_path: Path, auth_keys_path: Path | None = None, personal_accounts_path: Path | None = None):
        self.file_path = file_path
        self.auth_keys_path = auth_keys_path or file_path.with_name("auth_keys.json")
        self.personal_accounts_path = personal_accounts_path or file_path.with_name("personal_accounts.json")
        self.file_path.parent.mkdir(parents=True, exist_ok=True)
        self.auth_keys_path.parent.mkdir(parents=True, exist_ok=True)
        self.personal_accounts_path.parent.mkdir(parents=True, exist_ok=True)
    ...
    def health_check(self) -> dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "personal_accounts_file_exists": self.personal_accounts_path.exists(),
                "personal_accounts_file_path": str(self.personal_accounts_path),
            }
